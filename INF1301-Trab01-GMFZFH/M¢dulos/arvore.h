...
*	    4.00  gmfzfh 18/03/2015 Inserção do protótipo da função ARV_CosturaArvore
...
/***********************************************************************
*
*  $FC Função: ARV Costurar árvore
*
*  $ED Descrição da função
*     Costura os nós folhas da árvore.
*     No caso da árvore ter um único nó, não faz nada.
*	  Imprime as chaves costuradas em ordem alfabética
*
*  $FV Valor retornado
*	  ARV_CondRetOK
