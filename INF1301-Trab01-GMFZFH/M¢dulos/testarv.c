...
*		5.00  gmfzfh 24/03/2015 Implementação de complementos da função de efetuar 
*								comandos (inserir) e revisão
*		4.00  gmfzfh 22/03/2015 Implementação de complementos da função de efetuar 
*								comandos (costurar)
...
*	  "=costurar"   - chama a função ARV_CosturaArvore( )
*
/****************************************************************************/
...
TST_tpCondRet TST_EfetuarComando( char * ComandoTeste )
{
	...
	else if ( strcmp( ComandoTeste , COSTURA_CMD ) == 0 )
	{
		...
		return TST_CompararInt( CondRetEsperada , CondRetObtido ,
			"Retorno errado ao costurar árvore." ) ;
